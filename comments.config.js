  ...
  tsDoc: Object.freeze({
    ...
    library: Object.freeze({
      consts: Object.freeze({
        public: Object.freeze({
          successFalse:
            "$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSFALSE` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSFALSE}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSFALSE / core: $COMMENT#EN#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSFALSE */,
          successTrue:
            "$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSTRUE` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_TRUE` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSTRUE}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSTRUE / core: $COMMENT#EN#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSTRUE */,
          typeError:
            "$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEERROR` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_ERROR` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEERROR}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEERROR / core: $COMMENT#EN#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEERROR */,
          typeWarning:
            "$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEWARNING` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEWARNING}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEWARNING / core: $COMMENT#EN#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEWARNING */,
        }),
        parser: Object.freeze({
          public: Object.freeze({
            typeScriptAndJSXCompatible:
              "`languageOptions` object for instances of the `ESLint` and `Linter` classes enabling the linting of TypeScript and JSX (React) files." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PARSER#PUBLIC#TYPESCRIPTANDJSXCOMPATIBLE / core: $COMMENT#EN#TSDOC#LIBRARY#CONSTS#PARSER#PUBLIC#TYPESCRIPTANDJSXCOMPATIBLE */,
          }),
        }),
      }),
      defs: Object.freeze({
        public: Object.freeze({
          getSourceCode:
            "Gets the $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#ESLINTSOURCECODE from its absolute path." /* variations: $COMMENT#TSDOC#LIBRARY#DEFS#PUBLIC#GETSOURCECODE / core: $COMMENT#EN#TSDOC#LIBRARY#DEFS#PUBLIC#GETSOURCECODE */,
          makeSuccessFalseTypeError:
            "Makes a `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` object with a $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR of `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_ERROR}` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#BASEDONMESSAGEANDSTATUS." /* variations: $COMMENT#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEERROR / core: $COMMENT#EN#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEERROR */,
          makeSuccessFalseTypeWarning:
            "Makes a `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` object with a $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR of `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING}` $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#BASEDONMESSAGEANDSTATUS." /* variations: $COMMENT#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEWARNING / core: $COMMENT#EN#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEWARNING */,
        }),
      }),
      params: Object.freeze({
        public: Object.freeze({
          absolutePath:
            "The $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#ABSOLUTEPATH $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#ATHAND." /* variations: $COMMENT#TSDOC#LIBRARY#PARAMS#PUBLIC#ABSOLUTEPATH / core: $COMMENT#EN#TSDOC#LIBRARY#PARAMS#PUBLIC#ABSOLUTEPATH */,
          message:
            "The human-readable message of the $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#ERROR." /* variations: $COMMENT#TSDOC#LIBRARY#PARAMS#PUBLIC#MESSAGE / core: $COMMENT#EN#TSDOC#LIBRARY#PARAMS#PUBLIC#MESSAGE */,
          status:
            "The static status text of the $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#ERROR." /* variations: $COMMENT#TSDOC#LIBRARY#PARAMS#PUBLIC#STATUS / core: $COMMENT#EN#TSDOC#LIBRARY#PARAMS#PUBLIC#STATUS */,
        }),
      }),
      returns: Object.freeze({
        public: Object.freeze({
          getSourceCode:
            "The $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#ESLINTSOURCECODE, from which the AST (`sourceCode.ast`) and all comments (`sourceCode.getAllComments()`) can be extracted, inside a `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_TRUE}` object at its `sourceCode` key. In case of an error, a `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` object is returned instead." /* variations: $COMMENT#TSDOC#LIBRARY#RETURNS#PUBLIC#GETSOURCECODE / core: $COMMENT#EN#TSDOC#LIBRARY#RETURNS#PUBLIC#GETSOURCECODE */,
          makeSuccessFalseTypeError:
            "A `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` object with a $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR of `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_ERROR}`." /* variations: $COMMENT#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEERROR / core: $COMMENT#EN#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEERROR */,
          makeSuccessFalseTypeWarning:
            "A `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` object with a $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR of `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING}`." /* variations: $COMMENT#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING / core: $COMMENT#EN#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING */,
        }),
      }),
    }),
    tests: Object.freeze({
  ...
  tsDoc: Object.freeze({
    ...
    library: Object.freeze({
      consts: Object.freeze({
        public: Object.freeze({
          successFalse:
            "$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSFALSE` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSFALSE}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSFALSE / core: $COMMENT#FR#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSFALSE */,
          successTrue:
            "$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSTRUE` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_TRUE` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESSTRUE}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSTRUE / core: $COMMENT#FR#TSDOC#LIBRARY#CONSTS#PUBLIC#SUCCESSTRUE */,
          typeError:
            "$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEERROR` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_ERROR` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEERROR}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEERROR / core: $COMMENT#FR#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEERROR */,
          typeWarning:
            "$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#_APPLYLASTWITH  `...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEWARNING` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#TOENSURE `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SITSATTOPLIKE `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#PROPAPROPB, ...$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPEWARNING}`." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEWARNING / core: $COMMENT#FR#TSDOC#LIBRARY#CONSTS#PUBLIC#TYPEWARNING */,
        }),
        parser: Object.freeze({
          public: Object.freeze({
            typeScriptAndJSXCompatible:
              "Objet `languageOptions` pour instances de classes `ESLint` et `Linter` permettant l'analyse statique de fichiers TypeScript et JSX (React)." /* variations: $COMMENT#TSDOC#LIBRARY#CONSTS#PARSER#PUBLIC#TYPESCRIPTANDJSXCOMPATIBLE / core: $COMMENT#FR#TSDOC#LIBRARY#CONSTS#PARSER#PUBLIC#TYPESCRIPTANDJSXCOMPATIBLE */,
          }),
        }),
      }),
      defs: Object.freeze({
        public: Object.freeze({
          getSourceCode:
            "Obtient l'$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#ESLINTSOURCECODE à partir de son chemin absolu." /* variations: $COMMENT#TSDOC#LIBRARY#DEFS#PUBLIC#GETSOURCECODE / core: $COMMENT#FR#TSDOC#LIBRARY#DEFS#PUBLIC#GETSOURCECODE */,
          makeSuccessFalseTypeError:
            "Crée un objet `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` avec une $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR de `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_ERROR}` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#BASEDONMESSAGEANDSTATUS." /* variations: $COMMENT#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEERROR / core: $COMMENT#FR#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEERROR */,
          makeSuccessFalseTypeWarning:
            "Crée un objet `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` avec une $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR de `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING}` $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#BASEDONMESSAGEANDSTATUS." /* variations: $COMMENT#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEWARNING / core: $COMMENT#FR#TSDOC#LIBRARY#DEFS#PUBLIC#MAKESUCCESSFALSETYPEWARNING */,
        }),
      }),
      params: Object.freeze({
        public: Object.freeze({
          absolutePath:
            "Le $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#ABSOLUTEPATH $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#CONCERNÉ." /* variations: $COMMENT#TSDOC#LIBRARY#PARAMS#PUBLIC#ABSOLUTEPATH / core: $COMMENT#FR#TSDOC#LIBRARY#PARAMS#PUBLIC#ABSOLUTEPATH */,
          message:
            "Le message en clair de l'$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#ERROR." /* variations: $COMMENT#TSDOC#LIBRARY#PARAMS#PUBLIC#MESSAGE / core: $COMMENT#FR#TSDOC#LIBRARY#PARAMS#PUBLIC#MESSAGE */,
          status:
            "Le texte statique du statut de l'$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#ERROR." /* variations: $COMMENT#TSDOC#LIBRARY#PARAMS#PUBLIC#STATUS / core: $COMMENT#FR#TSDOC#LIBRARY#PARAMS#PUBLIC#STATUS */,
        }),
      }),
      returns: Object.freeze({
        public: Object.freeze({
          getSourceCode:
            "L'$COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#ESLINTSOURCECODE, à partir duquel l'AST (`sourceCode.ast`) et tous les commentaires (`sourceCode.getAllComments()`) peuvent être extraits, à l'intérieur d'un objet `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_TRUE}` à sa clé `sourceCode`. En cas d'erreur, un objet `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` est retourné à la place." /* variations: $COMMENT#TSDOC#LIBRARY#RETURNS#PUBLIC#GETSOURCECODE / core: $COMMENT#FR#TSDOC#LIBRARY#RETURNS#PUBLIC#GETSOURCECODE */,
          makeSuccessFalseTypeError:
            "Un objet `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` avec une $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR de `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_ERROR}`." /* variations: $COMMENT#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEERROR / core: $COMMENT#FR#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEERROR */,
          makeSuccessFalseTypeWarning:
            "Un objet `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` avec une $COMMENT#FR#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR de `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING}`." /* variations: $COMMENT#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING / core: $COMMENT#FR#TSDOC#LIBRARY#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING */,
        }),
      }),
    }),
  }),
