    ...
    core: Object.freeze({
      ...
      returns: Object.freeze({
        public: Object.freeze({
          ...
          makeSuccessFalseTypeWarning:
            "A `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SUCCESS_FALSE}` object with a $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#SINGLEERROR of `{$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#TYPE_WARNING}`." /* variations: $COMMENT#TSDOC#CORE#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING / core: $COMMENT#EN#TSDOC#CORE#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING */,
        }),
      }),
    }),
    tests: Object.freeze({
