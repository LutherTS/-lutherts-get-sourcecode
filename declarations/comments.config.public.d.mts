...
export declare const resolvedPublicData: {
    ...
    "libraryVariations": {
        "EN": {
            ...
            "GET_SOURCECODE#TSDOC#SRC#LIB#CONSTS#PARSER#PUBLIC#NOINLINECONFIG": "`linterOptions` object for instances of the `ESLint` and `Linter` classes disabling ESLint inline configs for programmatic ESLint usages.";
        ...
        "FR": {
            ...
            "GET_SOURCECODE#TSDOC#SRC#LIB#CONSTS#PARSER#PUBLIC#NOINLINECONFIG": "Object `linterOptions` pour instances de classes `ESLint` et `Linter` désactivant les configurations dans le code pour des usages programmatiques de ESLint.";
