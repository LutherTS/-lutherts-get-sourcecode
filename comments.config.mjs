    ...
    "jsDoc": {
      "consts": {
        "successFalse": {
          ...
          "key": "EN#JSDOC#CONSTS#SUCCESSFALSE"
        },
        "successTrue": {
          ...
          "key": "EN#JSDOC#CONSTS#SUCCESSTRUE"
        },
        "typeError": {
      ...
      "defs": {
        ...
        "makeSuccessFalseTypeError": {
          ...
          "key": "EN#JSDOC#DEFS#MAKESUCCESSFALSETYPEERROR"
        },
        "makeSuccessFalseTypeWarning": {
          ...
          "key": "EN#JSDOC#DEFS#MAKESUCCESSFALSETYPEWARNING"
        }
      },
      "params": {
        "absolutePath": {
          "value": "The absolute path of the file at hand.",
          "key": "EN#JSDOC#PARAMS#ABSOLUTEPATH"
        },
        "message": {
          "value": "The human-readable message of the error.",
          "key": "EN#JSDOC#PARAMS#MESSAGE"
        },
        "status": {
          "value": "The static status text of the error.",
          "key": "EN#JSDOC#PARAMS#STATUS"
        }
      },
      "returns": {
        "getSourceCode": {
          ...
          "key": "EN#JSDOC#RETURNS#GETSOURCECODE"
        }
      }
    },
    "composedVariablesExclusives": {
