          ...
          "defs": {
            "public": {
              ...
              "makeSuccessFalseTypeError": {
                ...
                "key": "EN#TSDOC#SRC#LIB#DEFS#PUBLIC#MAKESUCCESSFALSETYPEERROR"
              },
              "makeSuccessFalseTypeWarning": {
                ...
                "key": "EN#TSDOC#SRC#LIB#DEFS#PUBLIC#MAKESUCCESSFALSETYPEWARNING"
              }
            }
          },
          "params": {
            "public": {
              ...
              "message": {
                ...
                "key": "EN#TSDOC#SRC#LIB#PARAMS#PUBLIC#MESSAGE"
              },
              "status": {
                "value": "The static status text of the error.",
                "key": "EN#TSDOC#SRC#LIB#PARAMS#PUBLIC#STATUS"
              }
            }
          },
          "returns": {
            "public": {
              ...
              "makeSuccessFalseTypeError": {
                ...
                "key": "EN#TSDOC#SRC#LIB#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEERROR"
              },
              "makeSuccessFalseTypeWarning": {
                "value": "A `{success: false}` object with a single error in its `errors` array of `{type: warning}`.",
                "key": "EN#TSDOC#SRC#LIB#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING"
              }
            }
          }
        },
        "tests": {
          "defs": {
            "assertFailureWithMessage": {
              ...
              "key": "EN#TSDOC#SRC#TESTS#DEFS#ASSERTFAILUREWITHMESSAGE"
            },
            "assertSuccess": {
              "value": "Asserts that `getSourceCode` succeeds when it should.",
              "key": "EN#TSDOC#SRC#TESTS#DEFS#ASSERTSUCCESS"
            }
          },
          "params": {
            "getSourceCodeResults": {
              ...
              "key": "EN#TSDOC#SRC#TESTS#PARAMS#GETSOURCECODERESULTS"
            },
            "expectedMessage": {
              "value": "The expected message of the error that should be encountered during failure, from which the status can be inferred.",
              "key": "EN#TSDOC#SRC#TESTS#PARAMS#EXPECTEDMESSAGE"
            }
          },
          "returns": {
            "assertFailureWithMessage": {
              "value": "Void.",
              "key": "EN#TSDOC#SRC#TESTS#RETURNS#ASSERTFAILUREWITHMESSAGE"
            },
            "assertSuccess": {
              "value": "EN#TSDOC#TESTS#RETURNS#ASSERTFAILUREWITHMESSAGE",
              "key": "EN#TSDOC#SRC#TESTS#RETURNS#ASSERTSUCCESS"
            }
          }
        }
      }
          ...
          "defs": {
            "public": {
              ...
              "makeSuccessFalseTypeError": {
                ...
                "key": "FR#TSDOC#SRC#LIB#DEFS#PUBLIC#MAKESUCCESSFALSETYPEERROR"
              },
              "makeSuccessFalseTypeWarning": {
                ...
                "key": "FR#TSDOC#SRC#LIB#DEFS#PUBLIC#MAKESUCCESSFALSETYPEWARNING"
              }
            }
          },
          "params": {
            "public": {
              ...
              "message": {
                ...
                "key": "FR#TSDOC#SRC#LIB#PARAMS#PUBLIC#MESSAGE"
              },
              "status": {
                "value": "Le texte statique du statut de l'erreur.",
                "key": "FR#TSDOC#SRC#LIB#PARAMS#PUBLIC#STATUS"
              }
            }
          },
          "returns": {
            "public": {
              ...
              "makeSuccessFalseTypeError": {
                ...
                "key": "FR#TSDOC#SRC#LIB#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEERROR"
              },
              "makeSuccessFalseTypeWarning": {
                "value": "Un objet `{success: false}` avec une seule erreur dans son array `errors` de `{type: warning}`.",
                "key": "FR#TSDOC#SRC#LIB#RETURNS#PUBLIC#MAKESUCCESSFALSETYPEWARNING"
              }
            }
          }
        }
